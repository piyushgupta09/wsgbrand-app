        ...
        <div class="d-flex">
            ...
            <div class="flex-fill d-flex flex-column justify-content-between">
                ...
                <div class="btn-group d-flex">
                    <router-link :to="{ name: 'FactoryLedgerDetail', params: { ledgerId: dispatch.ledger_sid } }" 
                    ...
                    <router-link v-if="dispatch.is_billed" :to="{ name: 'FactoryLedgerDetail', params: { ledgerId: dispatch.ledger_sid } }" 
                    ...
                    <div v-else class="flex-fill d-flex">
                        <button v-if="isBrand" class="btn btn-sm btn-outline-dark flex-fill rounded-0 border-start-0 border-secondary" 
                            ...
                            <span class="pe-2">Stock In</span>
                            <i class="bi bi-chevron-down"></i>
                        </button>
                        <div v-else class="btn btn-sm btn-outline-dark flex-fill rounded-0 border-secondary border-end-0">
                            <span class="pe-2">Bill Pending</span>
