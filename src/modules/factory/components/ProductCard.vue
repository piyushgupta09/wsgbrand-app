<template>
    <div class="col position-relative">
        ...
        <div v-if="product.options && product.options.length" :id="'productImages' + productIndex" class="carousel slide">
            ...
            <div class="carousel-inner" style="height: 250px; max-height:250px; overflow-y: hidden;">
                ...
                <div v-for="(option, optionIndex) in product.options" :key="optionIndex"
                    ...
                    <router-link :to="{ name: 'FactoryLedgerDetail', params: { ledger: ledger.sid } }">
        ...
        <router-link v-else :to="{ name: 'FactoryLedgerDetail', params: { ledger: ledger.sid } }" class="td-none">
        ...
        <router-link :to="{ name: 'FactoryLedgerDetail', params: { ledger: ledger.sid } }" class="td-none text-dark">
